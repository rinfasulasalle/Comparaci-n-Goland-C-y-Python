...
def main():
    ...
    tamanios = [10,1000,1500,2000,2000,3000,3500]
    total_b = []
    total_m = []
    promedio_b = []
    promedio_m = []
    ...
    print(len(promedio_b))
    print(len(promedio_m))

    print(len(lista_arrays))
    print(len(lista_tiempo_b))
    print(len(lista_tiempo_m))
